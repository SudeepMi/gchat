                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <Form.Group className="row">
                                        ...
                                        <div className="col-sm-9">
                                            <select className="form-control" onChange={(e) => HandleCountry(e.target.value)} >
                                                {Countries.map((c, k) => {
                                                    return <option key={k} value={JSON.stringify(c)}>{c.name}</option>
                                                })}
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <Form.Group className="row">
                                        ...
                                        <div className="col-sm-9">
                                        <select className="form-control" onChange={(e) => setHeadOffice(e.target.value)} >
                                                {Cities.map((c, k) => {
